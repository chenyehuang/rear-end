...
urlpatterns = [
    ...
    path('api/signup/<int:user_id>', mine_page.signup, name='signup'),
    path('api/search/<int:user_id>', search_page.get_goods, name='focus_search'),
    path('api/index/get_picture/<int:user_id>', index_page.getpicgoods, name='get_picture'),
    path('api/index/get_rank/<int:user_id>', index_page.getrank, name='get_rank'),
    path('api/details/add_focus<int:user_id>', goods_detail.addfocus, name='add_focus'),
    path('api/details/get_comments/<int:user_id>', goods_detail.getcomments, name='get_comment'),
    path('api/focus/<int:user_id>', focus_page.userfocus, name='get_user_focus'),
    path('api/focus/<int:user_id>', focus_page.userdelete, name='user_delete_focus'),
]
